...
bin/exec: ./includes/GraphAdjList.hpp ./includes/solution.hpp ./src/solution.cc ./src/driver.cc
	$(CXX) $(CXXFLAGS) ./src/driver.cc ./src/solution.cc   -o $@

bin/tests: ./includes/GraphAdjList.hpp ./includes/solution.hpp ./src/solution.cc ./tests/tests.cc 
